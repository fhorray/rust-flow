    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 selection:bg-primary/20">
      <div className="max-w-md w-full text-center space-y-8 reveal active">
        ...
        <div className="space-y-3">
          <Badge variant="outline" className="border-red-500/20 text-red-500 py-1 px-3 bg-red-500/5 rounded-full text-[8px] font-black tracking-[0.2em] uppercase">
            Checkout Canceled
          </Badge>
          <h1 className="text-4xl md:text-5xl font-black italic tracking-tighter uppercase">Paused.</h1>
