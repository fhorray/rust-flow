    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 selection:bg-primary/20">
      <div className="max-w-md w-full text-center space-y-8 reveal active">
        ...
        <div className="space-y-3">
          <Badge variant="outline" className="border-primary/20 text-primary py-1 px-3 bg-primary/5 rounded-full text-[8px] font-black tracking-[0.2em] uppercase">
            Payment Confirmed
          </Badge>
          <h1 className="text-4xl md:text-5xl font-black italic tracking-tighter uppercase">Success.</h1>
          <p className="text-muted-foreground text-sm italic leading-relaxed">
            Your license is active. You are now authorized for high-intensity developer training.
          </p>
        </div>
        ...
        <div className="bg-black/40 border border-white/5 rounded-2xl p-6 space-y-4 text-left">
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="text-[10px] font-black uppercase tracking-widest mb-1">Get Started</h4>
              <p className="text-[11px] text-muted-foreground italic">Your plan status will sync automatically with the CLI.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href="/" className="w-full">
            <Button variant="ghost" className="w-full text-muted-foreground hover:text-white text-[10px] font-black uppercase tracking-[0.2em] h-12">
              Return Home
            </Button>
          </Link>
        </div>
